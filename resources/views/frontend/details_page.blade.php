    ...
    <div class="container">
       <div class="row">
          <div class="col-md-12">
             ...
             <button class="btn btn-light btn-sm border-light-btn" type="button"><i class="icofont-cauli-flower text-success"></i>  Best</button>
 ...
 <section class="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
            ...
            <div class="mall-category-item">
                <a href="#">
                    ...
                    @if ($populer->discount_price == NULL)
                        {{$populer->price}}TK
                    @else
                     <del>{{$populer->price}}</del>  {{$populer->discount_price}}TK
                    @endif
        ...
        <div class="bg-white rounded border shadow-sm mb-4">
            ...
            <div class="menu-list p-3 border-bottom"> 
                ...
                <div class="media">
                    ...
                    <p class="text-gray mb-0"> {{$product->price}}TK</p>
                    @if ($product->size == NULL)
                    <p class="text-gray mb-0"> </p>
                    @else    
                      <p class="text-gray mb-0"> ({{$product->size}})</p>
                    @endif
    ...
    <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
        <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
            ...
            <div class="mapouter">
                <div class="gmap_canvas"><iframe width="300" height="170" id="gmap_canvas" src="https://maps.google.com/maps?q=dhaka&t=&z=9&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div>
            </div>
            </div>
            ...
            <p class="mb-3">Beef, Biriyani, Mutthon Kacchi, Beef Thali,Paratha, Butter Naan, Dessert</p>
            <div class="border-btn-main mb-4">
            <a class="border-btn text-success mr-2" href="#"><i class="icofont-check-circled"></i> Breakfast</a>
            <a class="border-btn text-success mr-2" href="#"><i class="icofont-close-circled"></i> Lunch</a>
            <a class="border-btn text-success mr-2" href="#"><i class="icofont-check-circled"></i> Dinner</a>
            <a class="border-btn text-success mr-2" href="#"><i class="icofont-check-circled"></i> Meet Item</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="media">
                               ...
                               <div class="media-body">
                                  <div class="reviews-members-header">
                                     ...
                                     <h6 class="mb-1"><a class="text-black" href="#">ABCD</a></h6>
